...
from qtmlib.circuits.core import QRegMap, RegisterBox
from qtmlib.circuits.core.register_circuit import RegisterCircuit
...
from qtmlib.circuits.utils import (
    extend_functions,

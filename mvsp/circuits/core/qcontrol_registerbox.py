...
from mvsp.circuits.core import RegisterBox, RegisterCircuit
...
class QControlRegisterBox(RegisterBox):
    ...
    def __init__(
        ...
        from mvsp.circuits.utils import int_to_bits
...
class PytketQControlRegisterBox(QControlRegisterBox):
    ...
    default controlled register box used in mvsp.
    ...
    def __init__(
        ...
        """Initialise the QControlOracleBox."""
        from mvsp.circuits.core import extend_new_qreg_dataclass
